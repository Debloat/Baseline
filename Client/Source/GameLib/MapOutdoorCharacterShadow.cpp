...
void CMapOutdoor::CreateCharacterShadowTexture()
{
    ...
    if (FAILED(ms_lpd3dDevice->CreateTexture(m_wShadowMapSize, m_wShadowMapSize, 1, D3DUSAGE_RENDERTARGET, D3DFMT_A8R8G8B8, D3DPOOL_DEFAULT, &m_lpCharacterShadowMapTexture, nullptr)))
    {
...
bool CMapOutdoor::BeginRenderCharacterShadowToTexture()
{
    ...
    /* - DYNAMIC_SHADOWS ------------------------------------*/
    // we now have a light shader, we dont have directional lights ffp
