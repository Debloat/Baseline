...
/* - YOSUN_ADMIN_PANEL [Environment] ------------------- */
public:
    TEnvironmentData* GetEnvironmentData()
    {
        return const_cast<TEnvironmentData*>(mc_pEnvironmentData);
    }

    const TEnvironmentData* GetEnvironmentData() const
    {
        return mc_pEnvironmentData;
    }
/* ----------------------------------------------------- */
