...
class CGraphicTextInstance
{
    ...
    protected:
        ...
        void __BuildGeometry(RECT* pClipRect = nullptr);
    ...
    private:
        ...
        // Stage 2: cached geometry + per-page runs
        std::vector<TPDTVertex> m_batchVertices;
        std::vector<WORD>       m_batchIndices;
        std::vector<STextBatchRun> m_batchRuns;

        bool m_isGeometryDirty;
        bool m_hasCachedClip;
        int  m_cachedClipTop;
