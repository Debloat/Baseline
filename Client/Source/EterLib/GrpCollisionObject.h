...
class CGraphicCollisionObject : public CGraphicBase
{
    ...
    protected:
        ...
        bool IntersectCube(const D3DXMATRIX* c_pmatWorld, float sx, float sy, float sz, float ex, float ey, float ez, D3DXVECTOR3 & RayOriginal, D3DXVECTOR3 & RayDirection, float* pu,
                           float* pv, float* pt);
