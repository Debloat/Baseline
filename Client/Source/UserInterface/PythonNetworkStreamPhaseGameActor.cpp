...
bool CPythonNetworkStream::RecvCharacterAppendPacket()
{
    ...
    /*
     * [KaptanYosun Dev Note] Removed the TYPE_NPC check here,
     * for the sake of YOSUN_MULTILANGUAGE [MINIMAL]
     * so TYPE_NPC can get their name from locale Proto, not from server
     */
