...
void CSpeedTreeForest::SetupWindMatrices(float fDeltaTime)
{
    ...
    /* - YOSUN_CONTROL_CENTER ------------------------------ */
    const auto& ycc = GetYosunControlSettings().worldEditor;
    float fBaseAngle = m_fWindStrength * ycc.speedTree.windStrength;
    /* ----------------------------------------------------- */
    ...
    for (int j = 0; j < c_nNumWindMatrices; ++j)
    {
        ...
        /* - YOSUN_CONTROL_CENTER ------------------------------ */
        float fBaseFreq = m_fWindStrength * ycc.speedTree.windOscillationSpeed;
        /* ----------------------------------------------------- */
