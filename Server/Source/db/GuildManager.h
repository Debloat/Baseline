...
using TGuildWarInfo = struct SGuildWarInfo
{
    time_t		tEndTime;
    ...
    public singleton<CGuildManager>
{
    ...
    private:
        ...
        using stPairGuildWar  = std::pair<time_t, TGuildWarPQElement*>;
        using stPairSkillUsed = std::pair<time_t, TGuildSkillUsed>;
        using stPairWaitStart = std::pair<time_t, TGuildWaitStartInfo>;
