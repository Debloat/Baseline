...
bool ITEM_MANAGER::ReadEtcDropItemFile(const char* c_pszFileName)
{
    /* [KaptanYosun Dev Note]
        File format (etc_drop_item.txt):
            VNUM<TAB>PROBABILITY [# optional comment]

        Processing steps:
        [1] Open the drop file.
        [2] Read file line by line.
        [3] Skip empty or invalid lines.
        [4] Split line into VNUM and probability using tab delimiter.
        [5] Convert VNUM string to numeric value.
        [6] Validate probability.
        [7] Store drop probability as integer (prob * 10000).
    */
    ...
    while (fgets(buf, sizeof(buf), fp))
    {
        ...
        *cpTab = '\0';
        ...
        /* - [7] ------------------------------------------- */
        m_map_dwEtcItemDropProb[dwItemVnum] = static_cast<DWORD>(fProb * 10000.0f);
