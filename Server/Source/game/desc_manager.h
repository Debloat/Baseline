...
{
    public:
        using DESC_SET                   = std::unordered_set<LPDESC>;
        using CLIENT_DESC_SET            = std::unordered_set<LPCLIENT_DESC>;
        using DESC_HANDLE_MAP            = std::map<int, LPDESC>;
        using DESC_HANDSHAKE_MAP         = std::map<DWORD, LPDESC>;
        using DESC_ACCOUNTID_MAP         = std::map<DWORD, LPDESC>;
        using DESC_LOGINNAME_MAP         = std::unordered_map<std::string, LPDESC>;
        using DESC_HANDLE_RANDOM_KEY_MAP = std::map<DWORD, DWORD>;
