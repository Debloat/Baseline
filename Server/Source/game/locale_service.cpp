...
static void __LocaleService_Init_Multilanguage()
{
    ...
    g_setQuestObjectDir.clear();
    g_setQuestObjectDir.insert("locale/multilanguage/quest/object");
    g_stLocaleFilename = "locale/multilanguage/eng_string.txt";
...
bool LocaleService_Init(const std::string& c_rstServiceName)
{
    ...
    if ("multilanguage" == g_stServiceName)
    {
...
bool LC_InitLocalization(const std::string& szLocal)
{
    ...
    if (!g_stLocal.compare("multilanguage"))
    {
