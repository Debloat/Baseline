...
int CInputLogin::Analyze(LPDESC d, BYTE bHeader, const char* c_pData)
{
    ...
    switch (bHeader)
    {
        ...
        /* [KaptanYosun TODO] This is just a temporary fix mask, check if this is the real fix.
        * [SYSERR] CInputLogin::Analyze: login phase does not handle this packet! header 100
        */
