...
using TGuildMember = struct SGuildMember
{
...
#pragma pack(1)
using TGuildMemberPacketData = struct SGuildMemberPacketData
{
    DWORD pid;
    BYTE grade;
    BYTE is_general;
...
using TGuildGrade = struct SGuildGrade
{
...
using TGuildData = struct SGuildData
{
    DWORD	guild_id;
    DWORD	master_pid;
    DWORD	exp;
...
using TGuildWar = struct SGuildWar
{
...
class CGuild
{
    ...
    private:
        ...
        using TGuildMemberContainer = std::map<DWORD, TGuildMember>;
        TGuildMemberContainer m_member;

        using TGuildMemberOnlineContainer = CHARACTER_SET;
        TGuildMemberOnlineContainer m_memberOnline;

        using TGuildMemberP2POnlineContainer = std::set<DWORD>;
        ...
        using TEnemyGuildContainer = std::map<DWORD, TGuildWar>;
        ...
        using EventMap = std::map< DWORD, LPEVENT >;
